<%@ page language="java" import="java.util.*,com.dt59.entity.*" pageEncoding="GB18030"%>
<%
	...
	<table align="center" width="620" height="230" border="0" cellpadding="0" cellspacing="0">
	  <tr height="35">
		...
		<%-- <c:if test="${not empty newsList}">
			...
			<%
			List<News> listnews=(List<News>)session.getAttribute("list");
			for( int i=0;i<listnews.size();i++){
				out.print("<tr><td height='22'>&nbsp;<a target='_parent' href='#'>"+listnews.get(i).getNtitle()+"&nbsp;&nbsp;&nbsp;<span style='color: red;'>["+listnews.get(i).getNdate()+"]</span></a></td>");
			}
			%>
			<%--<tr>
