	  		...
	  		<tr align="center">
	  			<td>
	  				...
	  				<div id=b>
	  						...
	  						--%>
	  						<%
	  						List<Product> listnews=(List<Product>)session.getAttribute("prolist");
	  						for( int i=0;i<listnews.size();i++){
	  							out.print("<img src='Img_Proscenium/listnews.get("+i+").getPpicture()' width='100%' height='112 align='middle' />");
	  						}
	  						%>
	  				</div>
	  				<div id=c></div>
