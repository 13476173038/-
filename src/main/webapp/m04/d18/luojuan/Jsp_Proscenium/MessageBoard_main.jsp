	        ...
	        <table width="750" border="0" cellspacing="0" cellpadding="0" style="font-size:12px;">
			  ...
			  <%-- <c:if test="${not empty messList}">--%>
			  	<c:forEach items="${listmess}" var="m"> 
		            ...
		            <td height="25" class="lb"><span class="gray">&nbsp;<img src="Img_Background/1/jd-to.gif" width="13" height="13" border="0" />&nbsp;
		            	<a href="revert?id=${m.mid}" target="_parent">${m.mtitle }</a></span></td>
