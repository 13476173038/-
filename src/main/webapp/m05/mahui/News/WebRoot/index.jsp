...
<html>
  ...
  <body>
   <div id="header">
	  <div id="top_login">
	    <label> 登录名 </label>
	    <input type="text" id="uname"   class="login_input" />
	    <label> 密&#160;&#160;码 </label>
	    <input type="password" id="upwd"  class="login_input" />
...
<div id="container">
  ...
  <div class="main">
    ...
    <div class="content">
      ...
      <ul class="classlist">
      <%
      	List<CommentInfo> commentInfo=(List<CommentInfo>)request.getAttribute("commentInfo");
      	for(int i=0;i<commentInfo.size();i++){
      		out.print("<li><a href='newspages/news_add.html'> "+commentInfo.get(i).getComment()+" </a><span> "+commentInfo.get(i).getFbtime()+" </span></li>");
      	}
       %>
